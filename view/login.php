...
<nav class="navbar" style="background-color: #f9f9f9;">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="?classe=Usuario&acao=cadastro">Ainda n�o efetuou o cadastro? Cadastre-se</a></li>
    </ul>
</nav>
...
<div class="container-fluid bg_cadastro">
	<div class="row">
		...
		<div class="col-md-4">
			...
			<form name="cadastro" class="form-group cadastro" method="POST" action="?classe=Usuario&acao=login">
