...
<head><meta http-equiv="Content-Type" content="text/html; charset=ibm866">
    ...
    <title>Naeco - Login de Parceiros</title>
...
<nav class="navbar" style="background-color: #f9f9f9;">
    ...
    <ul class="nav navbar-nav navbar-right">
        <li><a href="?classe=Parceiro&acao=cadastro">Ainda não efetuou o cadastro? Se torne um parceiro!</a></li>
    </ul>
</nav>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="col-md-12 text-center">
                <h2 style="margin-bottom: 50px;">Entre em sua conta</h2>
            </div>
            <form name="cadastro" class="form-group cadastro" method="POST" action="?classe=Parceiro&acao=login">
                <p class="lbl_cadastro">CNPJ</p>
                <input type="number" name="cnpj" placeholder="CNPJ" class="form-control box shadow-sm" required>
