...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-3">
        <h2 style="margin-bottom: 50px; margin-top: 50px;">Histórico de Débitos</h4>
        </div>
            ...
            <table class="table" style="width:100%; margin-top: 50px;">
                ...
                <tbody>
                    <?php foreach($debitos as $debito){ ?>
                        <tr>
                            <td><?=$debito->nome_fantasia_parceiro?></td>
                            <td><?=$debito->valor_debito?></td>
                            <td><?=$debito->data_debito?></td>
                        </tr>
                    <?php } ?>
                </tbody>
