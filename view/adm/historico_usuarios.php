...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-3">
            <h2 style="margin-top: 50px;">Histórico de Usuários</h2>
            <h4 style="font-family: Quicksand, sans-serif">Todos os usuários cadastrados na base de dados</h4>
        </div>
                ...
                <?php
                    foreach($usuarios as $usuario){ ?>
                        <tr>
                            ...
                            <td><?=$usuario->cep_usuario;?></td>
                            <td><?=$usuario->id_saldo?></td>
                            <td><?=$usuario->valor_saldo?></td>
