...
<div id="mySidenav" class="sidenav">
    ...
    <a href="configuracoes.php"><i class="fa fa-cogs fa-xs"></i> Configurações</a>
...
<center>
            <h3 class="mt-5" style="color: #57bf46;">Configurações</h3>
<br><br>

    <div class="col-lg-9">
        <div class="box">

        <h4 class="mt-5" style="color: #57bf46;">Alterar Senha</h4>
            <form method="POST" action="../../?classe=Adm&acao=updatesenha">
              <div class="row">
                    <div class="col-md-6">
