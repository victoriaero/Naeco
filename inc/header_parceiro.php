...
<div id="mySidenav" class="sidenav">
 ...
 <br><br>
  ...
  <a href="busca_cpf.php"><i class="fa fa-address-card fa-xs"></i> Buscar CPF</a>
  <a href="suporte.php"><i class="fa fa-question-circle fa-xs"></i> Suporte</a>
  <a href="relatorios.php"><i class="fa fa-list fa-xs"></i> Relatórios</a>
