...
<div id="mySidenav" class="sidenav">
 ...
 <a href="../../?classe=Usuario&acao=perfil"><i class="fa fa-user fa-xs"></i> Meu perfil</a>
  <a href="../../?classe=Usuario&acao=usuario_saldo"><i class="fa fa-check-circle fa-xs"></i> Pontuação</h4></a>
    <a href="historico.php"><i class="fa fa-list fa-xs"></i> Histórico</a>
  <a href="codigo.php"><i class="fa fa-plus fa-xs"></i> Inserir Código</a>
  <a href="suporte.php"><i class="fa fa-question fa-xs"></i> Suporte</a>
  <a href="../../?classe=Usuario&acao=logout"><i class="fa fa-power-off fa-xs"></i> Logout</a>

  <br><br>
<hr>
  <a href="../../?classe=Usuario&acao=delete"><i class="fa fa-times fa-xs"></i> Encerrar minha conta</a>
  <hr>
</div>
