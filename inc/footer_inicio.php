    ...
    <div class="row">
      ...
      <div class="col-md-6 footer-nav">
        <nav class="navbar navbar-light">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="view/contato.php">Fale com a gente</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="view/parceiros.php">Parceiros</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="?classe=Usuario&acao=cadastro">Seja um usuário</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="?classe=Parceiro&acao=cadastro">Seja um parceiro</a>
            </li>
          </ul>
        </nav>
      </div>
